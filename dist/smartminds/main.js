...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onShowBoring = function (element) {
...
/* harmony import */ var _shared_header_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/header/sidebar/sidebar.component */ "./src/app/shared/header/sidebar/sidebar.component.ts");
/* harmony import */ var _shared_header_nav_nav_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/header/nav/nav.component */ "./src/app/shared/header/nav/nav.component.ts");
...
/* harmony import */ var _views_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./views/dashboard/dashboard.component */ "./src/app/views/dashboard/dashboard.component.ts");
...
/* harmony import */ var _views_user_user_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./views/user/user.service */ "./src/app/views/user/user.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _shared_header_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_7__["SidebarComponent"],
                _shared_header_nav_nav_component__WEBPACK_IMPORTED_MODULE_8__["NavComponent"],
                ...
                _views_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"],
            ...
            imports: [
                ...
                _ngrx_store__WEBPACK_IMPORTED_MODULE_14__["StoreModule"].forRoot(_app_reducer__WEBPACK_IMPORTED_MODULE_16__["reducers"]),
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__["JwtModule"].forRoot({
                    jwtOptionsProvider: {
                        ...
                        deps: [_auth_auth_service__WEBPACK_IMPORTED_MODULE_17__["AuthService"]],
                    }
                })
            ],
            providers: [_views_user_user_service__WEBPACK_IMPORTED_MODULE_18__["UserService"]],
...
var AuthService = /** @class */ (function () {
    ...
    // Get the token
    AuthService.prototype.getAsyncToken = function () {
...
module.exports = "<footer class=\"footer\">\n  <div class=\"d-sm-flex justify-content-center justify-content-sm-between\">\n    <span class=\"text-muted text-center text-sm-left d-block d-sm-inline-block\">Copyright © 2018 <a href=\"\" target=\"_blank\">SmartMinds</a>. All rights reserved.</span>\n    <!--<span class=\"float-none float-sm-right d-block mt-1 mt-sm-0 text-center\">SmartMinds </span>-->\n  </div>\n</footer>\n"
...
/***/ "./src/app/shared/header/nav/nav.component.css":
/*!*****************************************************!*\
  !*** ./src/app/shared/header/nav/nav.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/header/nav/nav.component.html":
/*!******************************************************!*\
  !*** ./src/app/shared/header/nav/nav.component.html ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/header/nav/nav.component.ts":
/*!****************************************************!*\
  !*** ./src/app/shared/header/nav/nav.component.ts ***!
  \****************************************************/
...
/***/ "./src/app/shared/header/sidebar/sidebar.component.css":
/*!*************************************************************!*\
  !*** ./src/app/shared/header/sidebar/sidebar.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/header/sidebar/sidebar.component.html":
/*!**************************************************************!*\
  !*** ./src/app/shared/header/sidebar/sidebar.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/header/sidebar/sidebar.component.ts":
/*!************************************************************!*\
  !*** ./src/app/shared/header/sidebar/sidebar.component.ts ***!
  \************************************************************/
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.onUpdateMaisonToActive = function () {
        this.active = '';
        console.log(this.active);
    };
    SidebarComponent.prototype.onUpdateHistoriqueToActive = function () {
        this.active = 'historique';
        console.log(this.active);
    };
    SidebarComponent.prototype.onUpdateAccountToActive = function () {
        this.active = 'account';
        console.log(this.active);
    };
...
/*!******************************************************!*\
  !*** ./src/app/views/dashboard/dashboard.actions.ts ***!
  \******************************************************/
/*! exports provided: ADD_ROOM, AddRoom */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _dashboard_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.actions */ "./src/app/views/dashboard/dashboard.actions.ts");
...
function dashboardReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _dashboard_actions__WEBPACK_IMPORTED_MODULE_1__["ADD_ROOM"]:
...
var getRoomById = function (id) { return Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRooms, function (rooms) {
    ...
    return rooms.find(function (room) { return room.id == id; });
}); };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _user_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]])
    ], LoginComponent);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUser = function () {
        this.http.get('api/users').subscribe(function (data) { return console.log(data); });
    };
